                    ...
                    $.ajax({
                        ...
                        success: function (data, text, xhr) {
                            ...
                            if (opts.autocomplete && typeof($.fn.autocomplete) == 'function' && opts.allowEdit) {
                                $(inputField).autocomplete({"source": tags.availableTags});
                            }
                        },
                    ...
                    // Make an AJAX request to get the list of tags based on typed data
                        ...
                        $(inputField).autocomplete({
                            source: function (request, response) {
                                opts.getData.params[opts.queryname] = request.term;
                                var lastXhr = $.post(opts.getURL, opts.getData, function (data, status, xhr) {
