...
(function(addon) {
    ...
    UI.component('htmleditor', {
        ...
        defaults: {
            ...
            height       : 500,
            maxsplitsize : 1000,
            codemirror   : { mode: 'htmlmixed', lineWrapping: true, dragDrop: false, autoCloseTags: true, matchTags: true, autoCloseBrackets: true, matchBrackets: true, indentUnit: 4, indentWithTabs: false, tabSize: 4, hintOptions: {completionSingle:false}, inputStyle: 'contenteditable' },
            toolbar      : [ 'bold', 'italic', 'strike', 'link', 'image', 'media', 'blockquote', 'code', 'listUl', 'listOl', 'youtube' ],
            lblPreview   : 'Preview',
            lblCodeview  : 'HTML',
        ...
        init: function() {
            ...
            // enable spell checking, which must be done after disableBrowserMagic() is called
            this.editor.display.lineDiv.setAttribute("spellcheck", "true");
    ...
    UI.plugin('htmleditor', 'base', {
        ...
        init: function(editor) {
            ...
            editor.addButtons({
                ...
                media : {
                    title  : 'Media',
                    label  : '<i class="uk-icon-youtube-play" onclick="$(\'#rowMedia\').show();"></i>'
                },
                listUl : {
                ...
                youtube : {
                    title  : 'YouTube',
                    label  : '<div id="rowMedia" style="display: none"><br><i class="uk-icon-youtube" style="font-size: 250%; position: relative; top: 5px"></i></div>'
                }
            });
            ...
            addAction('code', '<code>$1</code>');
            addAction('youtube', '<iframe id="mediaVideo" src="https://www.youtube.com/embed/$1" width="320" height="180" style="max-width: 100%"></iframe>');
    ...
    UI.plugin('htmleditor', 'markdown', {
        ...
        init: function(editor) {
            ...
            addAction('code', '```\n$1\n```');
            addAction('youtube', '[GBBYT](https://www.youtube.com/watch?v=)');
