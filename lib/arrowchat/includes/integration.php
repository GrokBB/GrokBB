<?php
	...
	*/
	...
	$dbOld = $db; include(dirname(__FILE__) . '/../../../cfg.php'); $db = $dbOld;
	...
	function get_user_id() 
	{
    	...
    	if (!empty($_SESSION['user'])) {
    		...
    		$result = $db->execute("
    			...
    			WHERE remember = '" . $db->escape_string($_COOKIE['uid']) . "'
    		");
	...
	function get_link($link, $user_id) 
	{
		...
		return $base_url . '../../user/view/' . $user_id;
	}
	...
	function get_avatar($image, $user_id) 
	{
		...
		return $base_url . "../../img.php?uid=" . $user_id;
	}
